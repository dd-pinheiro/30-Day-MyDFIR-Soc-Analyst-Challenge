...
2. **Reconhecimento**: Essa será a fase de reconhecimento, onde procuraremos informações dentro do sistema.
3. **Defense Evasion**: Nessa fase, desativaremos qualquer tipo de proteção que pode nos detectar futuramente, com o intuito de que não sejam geradas logs no Elastic enquanto estivermos instalando o Agente do Mythic na máquina
...
5. **Command & Control**: Nesta fase, criaremos um arquivo chamado *passwords.txt* (com o intuito de simular que encontramos esse arquivo)
