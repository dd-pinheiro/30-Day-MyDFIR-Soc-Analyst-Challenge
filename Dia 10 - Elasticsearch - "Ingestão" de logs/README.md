...
1. No homepage do Elastic, adicionei a integração *Custom Windows Event Logs* clicando em "**Add Integrations**".
2. Preenchi os campos **Integration Name** e **Description**. Vale ressaltar que o campo "Channel Name" deve conter o nome do completo do Sysmon, para obter essa informação realizei o passo a passo abaixo no Event Viewer do Windows:
...
3. Em seguida, cliquei "Next" e adicionei essa integração na *Policy* criada no **Dia 8**, nomeada de *Windows Policy*
<img width="753" height="251" alt="image" src="https://github.com/user-attachments/assets/4b250434-11f4-45db-8465-ea231ea3190d" />

4. Por fim, adicionei a integração clicando em "**Save and Deploy Changes**".


### 2) Adicionando integração do Windows Defender
1. Realizei o mesmo processo feito em **Adicionando Integração do Sysmon**, porém customizei a integração do Windows Defender para apenas capturar logs relacionadas aos *Event ID's 1116,1117* e *5001*
2. Novamente, selecionei a política recém criada do Windows, e cliquei em "**Save and Deploy Changes**".

### 3) Verificação das Logs
Ao realizar o Passo 1 e 2, verifiquei as logs sendo geradas na aba "Discover" no Elasticsearch.
