...
## 🎯 Objetivo do Dia
Compreender como funciona o protocolo **Remote Desktop Protocol (RDP)** e analisar como esse serviço é frequentemente utilizado por atacantes em incidentes de ransomware e como identificar serviços RDP expostos na internet.
Compreender os conceitos fundamentais do **Remote Desktop Protocol (RDP)**, analisar como esse serviço é frequentemente visado por atacantes em incidentes de ransomware e explorar técnicas de avaliação de exposição e segurança para acessos remotos.

---

## 🔗 RDP - Remote Desktop Protocol
Esse protocolo é utilizado para uma comunicação entre um Servidor e um Cliente. O RDP é encapsulado e utilizado criptografia com o protocolo TCP da camada de Transporte do modelo TCP/IP; utiliza a porta 3389 por padrão.
